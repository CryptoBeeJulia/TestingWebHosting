...
const filterBtn = document.querySelectorAll(".filter-btn");
  ...
  /* Content from previous class! not a good way to do it!
let tag = "<p>Hello</p>";
let x = "";
for(let i = 0; i<3; i++)
{
...
// `` - allows to write multiline code
...
displayMenu = displayMenu.join("");
// console.log(displayMenu);
// inner html line is missing here
sectionCenter.innerHTML = displayMenu
...
// homework - page + project

// project = scetch idea, html
// page - apply filter function - buttons show 1 section
// if I want to add buttons and categories - make it in html
